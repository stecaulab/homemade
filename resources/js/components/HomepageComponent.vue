<template>
    <div>
        <nav>
            <section>
                <a style="color:white" href="/admin/dashboard">FF-Homemade</a>&nbsp; || &nbsp;
        ...
        <article>
                 <header>
                <header class="d-inline"> Benvenuto, {{ userName }}</header>


                <p @click="logout" class="float-right" style="cursor:pointer">LogOut</p>
